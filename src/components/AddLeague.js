                ...
                <ModalBody>
                    <Form>
                        ...
                        <FormGroup>
                            <Row>
                                <Col xs="2"><Label>League: </Label></Col>
                                <Col xs="10"><Input type="name" name="league_logo_link" id="league_logo_link" value={this.state.league_logo_link} onChange={this.handle} placeholder="Paste url of the logo"/></Col>
                            </Row>
                        </FormGroup>
                        <FormGroup>
                            <Row>
                                <Col xs="2"><Label>Format </Label></Col>
                                <Col xs="10"><Input type="select" name="league_format" id="league_format" value={this.state.league_format} onChange={this.handle} placeholder="Choose format type">
                                <option>T20</option>
                                <option>ODI</option>
                                <option>Test</option>
                                 </Input>   
