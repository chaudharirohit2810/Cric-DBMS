                    ...
                    <Form>
                        <FormGroup>
                            <Row>
                                ...
                                <Col xs="10"><Input type="name" name="league_name" id="league_name" value={this.state.league_name} onChange={this.handle1} placeholder="Enter league name"/></Col>
                            </Row>
                        </FormGroup>
                        <FormGroup>
                            <Row>
                                <Col xs="2"><Label>Format </Label></Col>
                                <Col xs="10"><Input type="select" name="format" id="format" value={this.state.format} onChange={this.handle2} placeholder="Choose format type">
                                <option>T20</option>
                                <option>ODI</option>
                                <option>Test</option>
                                 </Input>   
