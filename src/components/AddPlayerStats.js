...
class AddPlayerStats extends Component {
    ...
    componentDidMount(props) {
        ...
        console.log(
            `${this.state.league_id} and for team ${this.state.team_id}`
        );
    }
    ...
    handleSubmit = (event) => {
        ...
        axios
            .post("http://localhost:5000/player_stats/", body)
            .then((response) => {
        ...
        axios
            .post("http://localhost:5000/plays/", {
                                ...
                                <Row>
                                    ...
                                    <Col xs="10">
                                        <Input
                                            ...
                                            onChange={this.handle}
                                            placeholder="Enter overs delivered"
                                        />
                                    </Col>
                                </Row>
                            </FormGroup>
                                ...
                                <Row>
                                    ...
                                    <Col xs="10">
                                        <Input
                                            ...
                                            name="best_bowling"
                                            id="best_bowling"
                                            value={this.state.best_bowling}
                                            onChange={this.handle}
                                            placeholder="Bowling figures in R/W format"
                                        />
                                    </Col>
                                </Row>
                            </FormGroup>
