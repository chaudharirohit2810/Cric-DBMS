  ...
  return (
    <div>
        <div style={{"text-align": "center", "marginTop": "5px"}}>
            ...
            <ModalHeader className="titleModal">{this.state.name}</ModalHeader>
                    {this.state.image_link ? <ModalHeader className="titleModal"><Col sm="auto"><img style={{height: '200px'}} src={this.state.image_link} alt="player"></img></Col><Col sm="auto"></Col></ModalHeader> : null}
